...
export interface ApiCareerListCareerList extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    buttonLink: Schema.Attribute.Component<'shared.logo-link', false>;
    ...
    JobTypeTag: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    PositionTag: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCareerPageCareerPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['components.hero', 'components.image']
    >;
    career_lists: Schema.Attribute.Relation<
      'oneToMany',
      'api::career-list.career-list'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiCaseStudyFieldCaseStudyField
  extends Struct.CollectionTypeSchema {
  collectionName: 'case_study_fields';
  info: {
    displayName: 'CaseStudyField';
    pluralName: 'case-study-fields';
    singularName: 'case-study-field';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCaseStudyItemCaseStudyItem
  extends Struct.CollectionTypeSchema {
  collectionName: 'case_study_items';
  info: {
    displayName: 'CaseStudyItem';
    pluralName: 'case-study-items';
    singularName: 'case-study-item';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCaseStudyServiceCaseStudyService
  extends Struct.CollectionTypeSchema {
  collectionName: 'case_study_services';
  info: {
    displayName: 'CaseStudyService';
    pluralName: 'case-study-services';
    singularName: 'case-study-service';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCaseStudyCaseStudy extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<['components.hero']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<['components.hero', 'components.map']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Component<'layout.email', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    navItem: Schema.Attribute.Component<'shared.link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    offices: Schema.Attribute.Component<'layout.office', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    phoneNumber: Schema.Attribute.Component<'layout.phone-number', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiServicePageServicePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['components.hero', 'components.service']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    test12: Schema.Attribute.Blocks;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::case-study-field.case-study-field': ApiCaseStudyFieldCaseStudyField;
      'api::case-study-item.case-study-item': ApiCaseStudyItemCaseStudyItem;
